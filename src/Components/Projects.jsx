    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <h5 className="text-center text-white" style={{backgroundColor:"#149ddd"}}>Viva Solutions</h5>
              <img src="/img\portfolio\home.png" class="img-fluid" alt=""/>
              <div class="portfolio-links">
                <a href="/img\portfolio\home.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
              </div>
            </div>
          </div>
